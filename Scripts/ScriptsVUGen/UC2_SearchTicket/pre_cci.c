# 1 "c:\\users\\artzay\\documents\\github\\vugen_practice_1\\scriptsvugen\\uc2_searchticket\\\\combined_UC2_SearchTicket.c"
...
# 1 "c:\\users\\artzay\\documents\\github\\vugen_practice_1\\scriptsvugen\\uc2_searchticket\\\\combined_UC2_SearchTicket.c" 2
...
# 2 "c:\\users\\artzay\\documents\\github\\vugen_practice_1\\scriptsvugen\\uc2_searchticket\\\\combined_UC2_SearchTicket.c" 2
...
# 3 "c:\\users\\artzay\\documents\\github\\vugen_practice_1\\scriptsvugen\\uc2_searchticket\\\\combined_UC2_SearchTicket.c" 2
...
# 4 "c:\\users\\artzay\\documents\\github\\vugen_practice_1\\scriptsvugen\\uc2_searchticket\\\\combined_UC2_SearchTicket.c" 2
...
Action()
{
	...
	for (i = 1; i <= count; i++) {
    	...
    	if (strstr(lr_eval_string("{AllCities}"), currentCity) == 0) {
...
lr_save_param_regexp(lr_eval_string("{AllCities}"),
	...
	lr_end_transaction("choosing a flight",2);
	lr_think_time(5);
	...
	lr_end_transaction("UC2_SearchTicket",2);

	return 0;
}
# 5 "c:\\users\\artzay\\documents\\github\\vugen_practice_1\\scriptsvugen\\uc2_searchticket\\\\combined_UC2_SearchTicket.c" 2
...
# 6 "c:\\users\\artzay\\documents\\github\\vugen_practice_1\\scriptsvugen\\uc2_searchticket\\\\combined_UC2_SearchTicket.c" 2
